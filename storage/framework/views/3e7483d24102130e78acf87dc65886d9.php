...
<div class="container">
    <nav class="navbar bg-body-tertiary d-flex justify-content-center">
        <div class="container-fluid justify-content-center">
            ...
            <a href="<?php echo e(route('seller.WithOutDriver',$shop_id)); ?>" class="btn btn-primary me-2"> With Out Driver</a>
            <a href="<?php echo e(route('seller.OrderDone',$shop_id)); ?>" class="btn btn-outline-primary me-2"> Order Done</a>
        ...
        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <div class="card  mb-3" style="max-width: 18rem;">
                    <h2 class="card-header text-bg-primary text-center a" > #<?php echo e($order->id); ?> Order  </h2>
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="javascript:void(0)" data-bs-toggle="modal" onclick="selectid(<?php echo e($order->id); ?>)" data-bs-target="#SelectDriver"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card" style="width: 22rem;">
                            ...
                            <form action="<?php echo e(route('seller.editDriver')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <select class="form-select"name="Dirver" id="Driver" size="2" aria-label="Size 3 select example">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>"><?php echo e($user->user->username); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/seller/WithOutDriver.blade.php ENDPATH**/ ?>