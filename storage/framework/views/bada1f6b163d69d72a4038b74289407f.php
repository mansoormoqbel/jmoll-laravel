...
unset($__errorArgs, $__bag); ?>" name="main_category" value="<?php echo e(old('main_category')); ?>" required autocomplete="main_category" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="sub_category" value="<?php echo e(old('sub_category')); ?>" required autocomplete="sub_category" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="brand" value="<?php echo e(old('brand')); ?>" required autocomplete="brand" autofocus>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>