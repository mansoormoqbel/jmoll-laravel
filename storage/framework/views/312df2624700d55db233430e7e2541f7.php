...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    <div class="col-md-8">
                        <form id="shopForm" method="POST" action="<?php echo e(route('admin.product.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/admin/product/create.blade.php ENDPATH**/ ?>