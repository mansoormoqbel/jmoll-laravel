      ...
      <div id="wrapper">
        ...
        <!-- Sidebar -->
          <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
              ...
              <li class="nav-item">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                      <div class="bg-white py-2 collapse-inner rounded">
                          ...
                          <a class="collapse-item" href="<?php echo e(route('admin.user.index')); ?>">Users</a>
                          <a class="collapse-item" href="<?php echo e(route('admin.admin.index')); ?>">Admin</a>
                          <a class="collapse-item" href="<?php echo e(route('admin.seller.index')); ?>">Seller</a>
                          <a class="collapse-item" href="<?php echo e(route('admin.driver.index')); ?>">Driver</a>
                      </div>
                  </div>
              </li>
               
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.feedback.index')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.driverinfo.index')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Driver</span></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.shop.index')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Shop</span></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.shopcart.index')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="<?php echo e(route('admin.shopcart.showCart')); ?>" 
                                >
                                <i class="fas fa-cart-arrow-down fa-fw"></i>
                                
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter"><?php echo e(session('count') ?? 0); ?></span>
                            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo e(asset('images/'.Auth::user()->profile_photo)); ?>">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('seller.logout')); ?>" data-toggle="modal" data-target="#logoutModal">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(route('driver.logout')); ?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/layouts/driver.blade.php ENDPATH**/ ?>