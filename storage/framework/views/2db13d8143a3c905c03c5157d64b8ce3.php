...
<div class="container">
    <nav class="navbar bg-body-tertiary d-flex justify-content-center">
        <div class="container-fluid justify-content-center">
            <a href="<?php echo e(route('seller.TakenByDriver',$shop_id)); ?>" class="btn btn-primary  me-2"> Taken By Driver</a>
                ...
                <div class="card  mb-3" style="max-width: 18rem;">
                    <h2 class="card-header text-bg-primary text-center"> #<?php echo e($order->id); ?> Order  </h2>
                        ...
                        <div class="card-body text-center">
                            ...
                            <a  class="btn btn-primary " href="<?php echo e(route('seller.OrderStatus',$order->id)); ?>">order Done</a>
                        </div>
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/seller/TakenByDriver.blade.php ENDPATH**/ ?>