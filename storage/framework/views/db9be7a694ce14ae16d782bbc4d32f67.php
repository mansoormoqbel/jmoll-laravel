...
<div class="container">
    <div class="row justify-content-center">
            ...
            <?php endif; ?>
        <div class="col-md-8">
            <form method="POST" action="<?php echo e(route('admin.seller.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    <label for="profile_photo" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Profile Photo')); ?></label>

                    <div class="col-md-6">
                        <input id="profile_photo" type="file" class="form-control <?php $__errorArgs = ['profile_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="profile_photo" value="<?php echo e(old('profile_photo')); ?>" required autocomplete="profile_photo" autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-0">
                    <div class="col-md-6 offset-md-4">
                        ...
                        <a class="btn btn-dark" href="<?php echo e(route('admin.seller.index')); ?>">Back to Dashboard Seller</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/admin/seller/create.blade.php ENDPATH**/ ?>