...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    <div class="col-md-8">
                        <form id="shopForm" method="POST" action="<?php echo e(route('seller.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mb-3">
                                    <label for="body" class="col-md-4 col-form-label text-md-end"><?php echo e(__('discrption')); ?></label>

                                    <div class="col-md-6">
                                        <textarea class="form-control" id="exampleFormControlTextarea1"  id="body" required  name="body"
                                         value="<?php echo e(old('body')); ?>" rows="5" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row p-auto m-auto">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a class="btn btn-dark" href="<?php echo e(route('seller.dashboard')); ?>">Back to Dashboard </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/seller/create.blade.php ENDPATH**/ ?>