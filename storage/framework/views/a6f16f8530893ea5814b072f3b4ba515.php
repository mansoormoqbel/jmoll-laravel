...
<div class="container">
    <div class="row justify-content-center">
            ...
            <?php endif; ?>
        <div class="col-md-8">
            <form method="POST" action="<?php echo e(route('admin.driver.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-0">
                    <div class="col-md-6 offset-md-4">
                        ...
                        <a class="btn btn-dark" href="<?php echo e(route('admin.driver.index')); ?>">Back to Dashboard Driver</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-app1\resources\views/admin/driver/create.blade.php ENDPATH**/ ?>