...
<div class="container">
    <nav class="navbar bg-body-tertiary d-flex justify-content-center">
        <div class="container-fluid justify-content-center">
            <a href="{{route('seller.TakenByDriver',$shop_id)}}" class="btn btn-primary  me-2"> Taken By Driver</a>
            <a href="{{route('seller.WithOutDriver',$shop_id)}}" class="btn btn-outline-primary me-2"> With Out Driver</a>
        ...
        @foreach ($orders as $order)
            <div class="col">
                <div class="card  mb-3" style="max-width: 18rem;">
                    <h2 class="card-header text-bg-primary text-center"> #{{$order->id}} Order  </h2>
                        ...
                        <div class="card-body text-center">
                            ...
                            <p  class="card-text" > Driver : {{$order->driverinfo->user->username}} </p>
                            ...
                            <a  class="btn btn-primary " href="{{route('seller.OrderStatus',$order->id)}}">order Done</a>
                        </div>
