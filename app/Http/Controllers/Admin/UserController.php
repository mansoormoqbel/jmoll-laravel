...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.user.index')->with(['error' => $th]);
        }
        ...
        try {
            ...
            if (!$user){
               /*  return ()->json(['status'=>0,'error'=>'User not find']); */
                return redirect()->route('admin.user.index')->with(['error' => 'User not find']);
            }
           ...
           //$user -> update(['status' =>$status ]);
            ...
            return redirect()->route('admin.user.index')->with(['success' => ' User Has Been Change Successfully!']);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.user.index')->with('error', 'User has been delete successfully!');
